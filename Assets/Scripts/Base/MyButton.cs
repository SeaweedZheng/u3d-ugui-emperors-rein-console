...
public class MyButton : Selectable, IPointerClickHandler, ISubmitHandler
{
    ...
    public ButtonPointerEvent m_onPointerDown = new ButtonPointerEvent();
    public ButtonPointerEvent OnPointerDownEvent
    {
    ...
    public ButtonPointerEvent m_onPointerUp = new ButtonPointerEvent();
    public ButtonPointerEvent OnPointerUpEvent
    {
